...
<script type="text/javascript">
	...
	function check(){
		...
		url = "confirmId.jsp?id=" + document.myForm.id.value;
		open(url, "confirm", "toolbar = no, location =no,menubar=no,scrollbars=no,resizable = no, width = 600, height = 200");
	...
	function makeQuestion() { // 질문 직접 선택 
		...
		if (cvalue2 == (clength2 - 1)) {
			...
			f.question2.value = "질문에서 직접입력을 선택하면 가입 가능합니다.";
		}
	}
</script>
</head>
	...
	<form name="myForm" method="post">
		<table width="1000" border="2" bordercolor="#EAEAEA"
			...
			<tr>
				...
				<td class="td2"><input type="text" name="id" /> @naver.com <input type="button" value="중복확인" onclick="check();" /><br /> 
					<span style="font-size: 8pt; color: #D5D5D5">입력하신 아이디로 네이버 이메일 주소가
						생성됩니다.</span></td>
			</tr>
			...
			<tr>
				...
				<td height="230" class="td2"><span style="color: orange">아래
					...
					<div style="background-color: #EAEAEA; height: 190">
						...
						<br />
						 &nbsp;&nbsp;<input type="text" style="width: 525pt; background-color: #A6A6A6;" 
							value="질문에서 직접입력을 선택하면 가입 가능합니다." readonly="readonly"
							name="question2" onfocus="style='width: 525pt; background-color:#ffffff'" onblur="style='width: 525pt; background-color:#A6A6A6;'"/><br /> &nbsp;&nbsp;답변 <input
						...
						&nbsp;&nbsp;<input type="text" name="email" /> @ <input
						 ...
						 <input type="checkbox" name = "chckbx" onclick="chked()"> 등록안함 <br /> &nbsp;&nbsp;<b>3.휴대폰
							...
							name="tel2"> <input type="checkbox" name = "chckbx" onclick="chked()" value ="등록" > 등록안함 <br />
						<br />
		...
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<img alt="" src="../html1/image/checkImg2.PNG" onclick="sendIt1();">
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
