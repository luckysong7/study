...
<form action ="mailSend_ok.jsp" method="post" name = "myForm" enctype="multipart/form-data"> 
	<table width="600" border = "0" cellspacing = "0" cellpadding = "3" align="center">
		<tr>
			<td colspan="2" height="3" bgcolor="#dbdbdb" align="left">			
			</td>
		</tr>	
		...
		<tr>
			<td colspan="2" height="1" bgcolor="#dbdbdb" align="left">
			</td>
		</tr>
			<tr>
			<td colspan="2" height="1" bgcolor="#dbdbdb" align="left">
		...
		<tr>
			<td height="30" width="140" bgcolor="#eeeeee" style ="padding-left : 20px;"> 첨부파일
			</td>	
