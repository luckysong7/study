...
<script type="text/javascript">
    ...
    function sendIt() {
		...
		*/
        ...
        f.action = "<%=cp%>/board/created_ok.jsp?pageNum=<%=pageNum%><%=param%>";
        f.submit();
    }
...
<div id="bbs">
	...
	<div id="bbsCreated_footer">
        ...
        <input type="button" value=" 작성취소 " class="btn2" onclick="javascript:location.href='<%=cp%>/board/list.jsp?<%=param%>&pageNum=<%=pageNum%>';"/>
	</div>
